...
- [https://console.akash.network/](https://console.akash.network/)
   ...
   ![Akash Console Homepage](/src/content/Docs/assets/sandbox-consol-homepage.png)
...
2. Click on **App Settings** from the menu
   ...
   ![Network Settings](/src/content/Docs/assets/sandbox-consol-configuration.png)
...
4. The change will be applied automatically
   ...
   ![Change Network](/src/content/Docs/assets/sandbox-network-selection.png)
